...
const LandingPage = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center p-[2.5vw] h-full w-full box-border">
      <div className="flex flex-1 flex-col md:flex-row w-full h-full">
        
        {/* Previous Songs Section */}
        <div className="flex flex-1 justify-center p-[1vw]">
        ...
        <div className="flex flex-1 flex-col justify-center items-center p-[1vw]">
        ...
        {/* About Section */}
        <div className="flex flex-1 flex-col p-[1vw] justify-between overflow-hidden">
